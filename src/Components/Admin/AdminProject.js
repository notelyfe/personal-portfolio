        ...
        <div className="container admin-project-container rounded mt-3">
            ...
            <form className={`my-2 rounded p-2 text-${modeStyle.textColor}`} style={{width: '350px', margin: 'auto', border: '2px solid #2C7090'}}>
                {/* <div id="drag-drop">
                    ...
                    <button id="addProductImage">+Add Project Image</button><br />
                    <input type="file" id='upload' hidden />
                </div> */}
                <div className="mb-3">
                    <label htmlFor="title" className="form-label">Project Title</label>
                    <input required type="text" className={`form-control bg-${modeStyle.bgColor} text-${modeStyle.textColor}`} id="title" aria-describedby="title" 
                    style={{border: '1px solid #2C7090'}}/>
                </div>
                <div className="mb-3">
                    <label htmlFor="description" className="form-label">Description</label>
                    <textarea required rows={5} type="text" className={`form-control bg-${modeStyle.bgColor} text-${modeStyle.textColor}`} id="description" style={{border: '1px solid #2C7090'}}/>
                </div>
